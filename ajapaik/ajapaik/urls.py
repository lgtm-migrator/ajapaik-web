...
urlpatterns = [
    re_path(r'^stream/', views.fetch_stream, name='fetch_stream'),
    re_path(r'^difficulty-feedback/', views.difficulty_feedback, name='difficulty_feedback'),
    re_path(r'^geotag/add/$', views.geotag_add, name='geotag_add'),
    re_path(r'^geotag/confirm/$', views.geotag_confirm, name='geotag_confirm'),
    re_path(r'^general-info-modal-content/$', views.get_general_info_modal_content, name='general_info_modal_content'),
...
urlpatterns += [
    ...
    re_path(r'^api/v1/logout/$', api.api_logout.as_view(), name='api_logout'),
    re_path(r'^api/v1/user/me/$', api.api_user_me.as_view()),
