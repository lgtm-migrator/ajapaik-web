...
urlpatterns = [
    ...
    url(r'^geotaggers-modal/<int:photo_id>/', views.geotaggers_modal, name='photo_geotaggers'),
    url(r'^geotag/$', views.game, name='game'),
    url(r'^login-modal/$', views.login_modal, name='login_modal'),
    url(r'^map/$', views.mapview, name='map'),
    url(r'^map/photo/<int:photo_id>/', views.mapview, name='map'),
    url(r'^map/rephoto/<int:rephoto_id>/', views.mapview, name='map'),
    url(r'^map/photo/<int:photo_id>/rephoto/<int:rephoto_id>/', views.mapview, name='map'),
    url(r'^map-data/$', views.map_objects_by_bounding_box, name='map_objects_by_bounding_box'),
    url(r'^leaderboard/$', views.leaderboard, name='leaderboard'),
    url(r'^leaderboard/album/<int:album_id>/', views.leaderboard, name='album_leaderboard'),
    url(r'^all-time-leaderboard/$', views.all_time_leaderboard, name='all_time_leaderboard'),
    url(r'^top50/$', views.top50, name='top50'),
    url(r'^top50/album/<int:album_id>/', views.top50, name='album_top50'),
    url(r'^photo/<int:photo_id>/upload/$', views.rephoto_upload, name='rephoto_upload'),
    url(r'^photo/<int:photo_id>/info\.json$', iiif.photo_info, name='iiif_photo_info'),
    url(r'^photo/<int:photo_id>/manifest\.json$', iiif.photo_manifest_v2, name='iiif_photo_manifest_v2'),
    url(r'^photo/<int:photo_id>/v2/manifest\.json$', iiif.photo_manifest_v2, name='iiif_photo_manifest_v2'),
    url(r'^photo/like/$', views.update_like_state, name='update_like_state'),
    url(r'^photo-upload-modal/<int:photo_id>/', views.photo_upload_modal, name='photo_upload_modal'),
    url(r'^photo/<int:photo_id>/', views.photoslug, name='photo'),
    url(r'^photo/<int:photo_id>/<str:pseudo_slug>/', views.photoslug, name='photo'),
    url(r'^video/(?P<video_id>\d+)/<str:pseudo_slug>/', views.videoslug, name='videoslug'),
    url(r'^video-still/$', views.generate_still_from_video),
    # Legacy URLs
    url(r'^foto_thumb/$', views.redirect_view),
    url(r'^foto_thumb/<int:photo_id>/', views.redirect_view),
    url(r'^foto_thumb/<int:photo_id>/<int:thumb_size>/', views.redirect_view),
    url(r'^foto_thumb/<int:photo_id>/<int:thumb_size>/<str:pseudo_slug>/', views.redirect_view),
    url(r'^foto_url/<int:photo_id>/', views.redirect_view),
    url(r'^foto_large/<int:photo_id>/', views.redirect_view),
    url(r'^foto_large/<int:photo_id>/<str:pseudo_slug>/', views.redirect_view),
    url(r'^photo-large/<int:photo_id>/', views.redirect_view),
    url(r'^photo-large/<int:photo_id>/<str:pseudo_slug>/', views.redirect_view),
    url(r'^photo-url/<int:photo_id>/', views.redirect_view),
    url(r'^photo-url/<int:photo_id>/<str:pseudo_slug>/', views.redirect_view),
    url(r'^foto/$', views.redirect_view, name='legacy_foto'),
    url(r'^foto/<int:photo_id>/', views.redirect_view, name='legacy_foto'),
    url(r'^foto/<int:photo_id>/<str:pseudo_slug>/', views.redirect_view, name='legacy_foto'),
    url(r'^ajapaikaja/$', views.redirect_view, name='legacy_game'),
    url(r'^kaart/$', views.redirect_view, name='legacy_map'),
    # Preferred URLs
    url(r'^photo-thumb/<int:photo_id>/', cache_page(86400)(views.image_thumb), name='image_thumb'),
    url(r'^photo-thumb/<int:photo_id>/', cache_page(86400)(views.image_thumb), name='image_thumb'),
    url(r'^photo-thumb/<int:photo_id>/<int:thumb_size>/', cache_page(86400)(views.image_thumb), name='image_thumb'),
    url(r'^photo-thumb/<int:photo_id>/<int:thumb_size>/<str:pseudo_slug>/', cache_page(86400)(views.image_thumb),
        name='image_thumb'),
    url(r'^photo-full/<int:photo_id>/<str:pseudo_slug>/', cache_page(86400)(views.image_full), name='image_full'),
    ...
    url(r'^photos/<int:album_id>/(?P<page>\d+)/$', views.frontpage, name='frontpage_photos'),
    ...
    url(r'^datings/<int:photo_id>/', views.get_datings, name='get_datings'),
    ...
    url(r'^compare-photos/<int:photo_id>/<int:photo_id_2>/', views.compare_photos, name='compare-photos'),
    url(r'^compare-all-photos/$', views.compare_all_photos, name='compare-all-photos'),
    url(r'^compare-all-photos/<int:photo_id>/<int:photo_id_2>/', views.compare_all_photos,
        name='compare-all-photos'),
    url(r'^me/$', views.me, name='me'),
    url(r'^user/<int:user_id>/', views.user, name='user'),
...
urlpatterns += [
    ...
    url(r'^api/v1/album/<int:album_id>/', api.AlbumNearestPhotos.as_view()),
    url(r'^api/v1/album/<int:album_id>/information/$', api.AlbumInformation.as_view(), name='api_album_information'),
    url(
        r'^api/v1/album/<int:album_id>/photo/<int:photo_id>/',
    ...
    url(r'^api/v1/album_thumb/<int:album_id>/', api.api_album_thumb, name='api_album_thumb'),
    url(r'^api/v1/album_thumb/<int:album_id>/<int:thumb_size>/', api.api_album_thumb, name='api_album_thumb'),
    ...
    url(r'^api/v1/photo/applied-operations/<int:photo_id>/', api.PhotoAppliedOperations.as_view(),
        name='api_photo_applied_operations'),
    url(r'^api/v1/photo/suggestion/$', api.PhotoSuggestion.as_view(), name='api_photo_suggestion'),
    url(r'^api/v1/photo/suggestion/<int:photo_id>/', api.PhotoSuggestion.as_view(), name='api_photo_suggestion'),
    ...
    url(r'^api/v1/transcriptions/<int:photo_id>/', api.Transcriptions.as_view(), name='api_transcriptions'),
...
urlpatterns += [
    ...
    url(r'^comments/for/<int:photo_id>/', views.CommentList.as_view(), name='comments-for-photo'),
    url(r'^comments/post-one/<int:photo_id>/', login_required(views.PostComment.as_view()),
